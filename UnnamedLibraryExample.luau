...
--Library:CreateTab('Combat', 'ScrollingFrame')
--Library:CreateTab('Visuals', 'ScrollingFrame')
--Library:CreateTab('Player', 'ScrollingFrame')
--Library:CreateTab('Misc', 'ScrollingFrame')

Library:createSection("General", "Main")
